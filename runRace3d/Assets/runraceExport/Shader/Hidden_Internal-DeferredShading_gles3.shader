...
void main()
{
    ...
    u_xlat16_4.x = u_xlat0.x * u_xlat16_4.x + u_xlat16_7;
...
void main()
{
    ...
    u_xlat16_15 = texture(hlslcc_zcmp_ShadowMapTexture, txVec0);
    u_xlat16_4.x = (-_LightShadowData.x) + 1.0;
    u_xlat16_4.x = u_xlat16_15 * u_xlat16_4.x + _LightShadowData.x;
    ...
    u_xlat21 = dot(u_xlat16_5.xyz, (-u_xlat0.xyz));
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat21 = inversesqrt(u_xlat21);
    u_xlat2.xyz = vec3(u_xlat21) * u_xlat2.xyz;
    u_xlat21 = dot((-u_xlat2.xyz), u_xlat16_5.xyz);
    u_xlat21 = u_xlat21 + u_xlat21;
    u_xlat2.xyz = u_xlat16_5.xyz * (-vec3(u_xlat21)) + (-u_xlat2.xyz);
...
void main()
{
    ...
    u_xlat16_4.x = (-_LightShadowData.x) + 1.0;
    u_xlat16_4.x = u_xlat16_13 * u_xlat16_4.x + _LightShadowData.x;
...
void main()
{
    ...
    u_xlat21 = u_xlat21 + u_xlat21;
    u_xlat2.xyz = u_xlat16_4.xyz * (-vec3(u_xlat21)) + (-u_xlat2.xyz);
    u_xlat0.x = dot(u_xlat2.xyz, (-u_xlat0.xyz));
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat16_2 = texture(_CameraGBufferTexture1, u_xlat1.xy);
